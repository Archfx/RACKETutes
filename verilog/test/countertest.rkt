...
; (assert (equal? (abs-impl (bv #x00000000 32) (bv #x00000000 32)) 
;                   (abs-spec (bv #x00000000 32) (bv #x00000000 32))))
...
(test-case "eq1"
  (define s0 (update-adder_s
              ...
              [a (bv 4 32)]
              [b (bv 5 32)]))
;   (define i (input* 'a (bv #x00000000 32) 'b (bv #x00000000 32)))
    ; (assume (equal? (|adder_n a| s0) (bv #x00000000 32)))
    ; (assume (equal? (|adder_n b| s0) (bv #x00000000 32)))
    (assert (check-equal? (|adder_n c| s0) (abs-spec (bv 4 32) (bv 5 32)))))



; (test-case "eq"
;   (define s0 (new-symbolic-adder_s))
; ;   (define i (input* 'a (bv #x00000000 32) 'b (bv #x00000000 32)))
;     (assume (equal? (|adder_n a| s0) (bv #x00000000 32)))
;     (assume (equal? (|adder_n b| s0) (bv #x00000000 32)))
;     (assert (check-equal? (|adder_n c| s0) (abs-spec (bv #x00000000 32) (bv #x00000000 32)))))
